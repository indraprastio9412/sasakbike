...
const Terms = () => (
  <PageLayout>
    <SEO
      title="Syarat & Ketentuan Layanan — Sasak Bike"
      description="Ketentuan pemesanan, pembayaran COD, pengiriman, dan penggunaan layanan Sasak Bike Lombok."
    ...
    <section className="container py-14 max-w-4xl">
      ...
      <div className="space-y-5">
        {sections.map((s, i) => (
          ...
          >
            <h2 className="font-display font-bold text-lg mb-3 text-gradient">{s.title}</h2>
