...
const steps = [
  { icon: ShoppingCart, title: "Pilih Produk Sepeda", desc: "Klik produk Mazara R633 pada halaman produk untuk melihat detail." },
  { icon: Send, title: "Pilih Warna & Ukuran", desc: "Pada halaman detail, pilih warna dan ukuran sepeda yang diinginkan, lalu klik Beli Sekarang." },
...
const tips = [
  ...
  "Pastikan warna, ukuran, dan data pemesan sudah benar sebelum kirim form.",
...
const OrderGuide = () => (
  <PageLayout>
    <SEO
      title="Cara Pemesanan & Pembayaran COD — Sasak Bike"
      description="Panduan langkah demi langkah memesan sepeda Sasak Bike via WhatsApp dengan pembayaran COD di seluruh Lombok."
      path="/cara-pemesanan"
      jsonLd={{
        "@context": "https://schema.org",
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Bagaimana cara memesan sepeda?", acceptedAnswer: { "@type": "Answer", text: "Pilih varian di halaman produk, klik Beli Sekarang, isi form, lalu kirim ke WhatsApp admin." } },
          { "@type": "Question", name: "Apakah bisa COD?", acceptedAnswer: { "@type": "Answer", text: "Ya, kami melayani Cash On Delivery di seluruh Pulau Lombok." } },
          { "@type": "Question", name: "Berapa harga sepedanya?", acceptedAnswer: { "@type": "Answer", text: "Sepeda Mazara R633 dijual seharga Rp 1.500.000 per unit." } },
        ],
      }}
    />
    <PageHeader
