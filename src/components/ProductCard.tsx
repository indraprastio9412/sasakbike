...
const ProductCard = ({ product, index = 0 }: { product: Product; index?: number }) => (
  <div
    className="group relative rounded-2xl overflow-hidden bg-gradient-card border border-border shadow-card transition-smooth hover:-translate-y-2 hover:shadow-glow animate-fade-up"
  ...
  >
    ...
    <div className="p-5 space-y-3">
      ...
      <Link
        ...
        className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-gradient-primary text-primary-foreground font-bold text-sm transition-smooth hover:shadow-glow hover:scale-[1.02]"
      >
